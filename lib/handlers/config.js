...
const CONFIG_FILE_NAME = 'eb.config.js';
...
module.exports = class ConfigHandler{
    ...
    shouldPublish(){
        return this.config.release.publish;
    }
    ignoredFiles(){
    ...
    mergeConfig(data){
        if(typeof data === 'object'){
            if(typeof data.release === 'object'){
                ...
                if(typeof data.release.publish === 'boolean') this.config.release.publish = data.release.publish;
